...
public class Prediction : MonoBehaviour
{
    ...
    public void SimulatreTrajectory(Ball ballPrefab, Vector2 pos, Vector2 vel)
    {
        ...
        //ghostBall.transform.forward = vel;
        ghostBall.Init(vel, true);
        ...
        {
            _physicsScene.Simulate(Time.fixedDeltaTime);
            _lr.SetPosition(i, ghostBall.transform.position);
        }
    ...
    /* bad code i dont want to delete
        //var ghostObj = Instantiate(ballPrefab, pos, Quaternion.identity); //very bad 
        //Destroy(ghostBall.gameObject); //very bad
        //ghostBall.GetComponent<SpriteRenderer>().enabled = false;
     */
}
